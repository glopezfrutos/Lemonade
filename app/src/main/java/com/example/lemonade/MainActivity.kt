...
import com.example.lemonade.R.drawable.*
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            ...
            SELECT -> {
                ...
                lemonImage?.setImageResource(lemon_tree)
            }

            SQUEEZE -> {
                textAction.setText(R.string.lemon_squeeze)
                lemonImage?.setImageResource(lemon_squeeze)
            }
            DRINK -> {
                textAction.setText(R.string.lemon_drink)
                lemonImage?.setImageResource(lemon_drink)
            }

            RESTART -> {
                textAction.setText(R.string.lemon_empty_glass)
                lemonImage?.setImageResource(lemon_restart)
            }
        }
    }
